...
func insertRoundPlayerStats(ctx context.Context, tx pgx.Tx, rows []aggregate.RoundPlayerStatsRow) error {
	...
	columns := []string{
		...
		"first_kill", "first_death", "suicide", "killed_by_teammate", "killed_teammate", "killed_by_spike",
	...
	_, err := tx.CopyFrom(
		...
		pgx.CopyFromSlice(len(rows), func(i int) ([]any, error) {
			...
			return []any{
				...
				r.FirstKill, r.FirstDeath, r.Suicide, r.KilledByTeammate, r.KilledTeammate, r.KilledBySpike,
...
func insertMatchPlayerStats(ctx context.Context, tx pgx.Tx, rows []aggregate.MatchPlayerStatsRow) error {
	...
	columns := []string{
		...
		"trade_kills", "traded_deaths", "suicides", "team_kills", "deaths_by_spike", "multi_kills",
	...
	_, err := tx.CopyFrom(
		...
		pgx.CopyFromSlice(len(rows), func(i int) ([]any, error) {
			...
			return []any{
				...
				r.TradeKills, r.TradedDeaths, r.Suicides, r.TeamKills, r.DeathsBySpike, r.MultiKills,
				r.DoubleKills, r.TripleKills, r.QuadraKills, r.PentaKills,
...
func insertTeamMatchStats(ctx context.Context, tx pgx.Tx, rows []aggregate.TeamMatchStatsRow) error {
	...
	columns := []string{
		...
		"total_kills", "total_deaths", "first_kills", "first_deaths",
		"trade_kills", "traded_death", "suicides", "team_kills", "deaths_by_spike", "multikill",
	...
	_, err := tx.CopyFrom(
		...
		pgx.CopyFromSlice(len(rows), func(i int) ([]any, error) {
			...
			return []any{
				...
				r.TotalKills, r.TotalDeaths, r.FirstKills, r.FirstDeaths,
				r.TradeKills, r.TradedDeaths, r.Suicides, r.TeamKills, r.DeathsBySpike, r.Multikill,
